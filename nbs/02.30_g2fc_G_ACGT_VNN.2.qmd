...
> This version differs in that it is trying to predict ==residuals== relative to an enviromental mean not absolute yield
...
```{python}
cache_path = '../nbs_artifacts/02.30_g2fc_G_ACGT_VNN.2/'
...
logger = TensorBoardLogger("tb_logs", name="vnn-02.30-envres")                # 3. Update

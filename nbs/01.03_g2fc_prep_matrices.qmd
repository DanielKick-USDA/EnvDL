...
### ~~One Hot Encode G~~ Replaced by deduplicated version
...
```{python}
#TODO save out obs_geno_lookup
```

### One Hot Encode G (Deduplicated)

```{python}
# right now GMat is 135793, 2250. After deduplicating this will become 4926, 2250. That's only 3.6%!

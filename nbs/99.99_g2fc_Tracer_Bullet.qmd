...
```{python}
cache_path = '../nbs_artifacts/99.99_g2fc_Tracer_Bullet/'
...
#         W_type,
    ...
    def __getitem__(self, idx):
        ...
        if 'W' in self.out_names:
            ...
            if self.W_type == 'raw':
                WPlant = torch.from_numpy(WPlant)
...
#     G = [torch.from_numpy(e) for e in ACGT_gene_slice_list] ,
#     G_type = 'list',        
...
# [e for e in next(iter(training_dataloader))]
```

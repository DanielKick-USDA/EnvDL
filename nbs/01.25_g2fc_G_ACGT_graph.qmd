...
```{python}
cache_path = '../nbs_artifacts/01.25_g2fc_G_ACGT_graph/'
ensure_dir_path_exists(dir_path = cache_path)
```

```{python}
dataloader_batch_size = 10#00
...
# moved to 00.02_core_dlfn_Deep_Learning_Convenience_Functions
# def read_split_info(
...
#     testing_dataloader,
#     model,
# #     learning_rate = 1e-3, now treated as a kwarg
#     batch_size = 64,
#     epochs = 500,
#     model_prefix = 'model',
#     save_model = False,
...
```{python}
# (len(train_idx), dataloader_batch_size)
```

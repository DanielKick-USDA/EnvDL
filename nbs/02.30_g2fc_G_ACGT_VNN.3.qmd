...
> This notebook checks if the performance is a fluke of the training set
...
```{python}
cache_path = '../nbs_artifacts/02.30_g2fc_G_ACGT_VNN.3/'
...
logger = TensorBoardLogger("tb_logs", name="vnn-02.30-alt-train")                # 3. Update

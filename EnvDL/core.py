# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/00.00_core.ipynb.

# %% auto 0
__all__ = ['read_txt', 'print_txt', 'ensure_dir_path_exists', 'get_cached_result', 'put_cached_result', 'remove_matching_files',
           'find_df_shared_cols', 'find_df_col_mismatches', 'summarize_col_missing', 'sanitize_col']

# %% ../nbs/00.00_core.ipynb 4
def read_txt(path, 
...
# %% ../nbs/00.00_core.ipynb 5
def print_txt(path):
    print(read_txt(path = path))

# %% ../nbs/00.00_core.ipynb 6
